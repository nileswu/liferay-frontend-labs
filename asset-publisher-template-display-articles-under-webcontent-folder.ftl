...
<#list entries as entry>
	<#assign
		...
		journalFolder = assetRenderer.getAssetObject()

		groupId = journalFolder.getGroupId()
        journalFolderId = journalFolder.getFolderId()

		journalArticles = journalArticleLocalService.getArticles(groupId, journalFolderId)
	...
	<div class="asset-abstract">
		...
		<#list journalArticles as journalArticle>

			<#assign journalArticleTitle = journalArticle.getTitle() />
			<h4>
